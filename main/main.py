...
class MainWindow(QMainWindow):
    ...
    def createActions(self):
        ...
        self.restorePartAct = QAction(QIcon('icons/crack.png'), "R&estorePart", self, enabled=False,checkable=True, shortcut="")
        self.inpaintPartAct = QAction(QIcon('icons/paint-roller.png'), "InpaintPart", self, enabled=False, checkable=True, shortcut="")
        self.undoPartAct = QAction(QIcon('icons/undo.png'), "UndoPart", self, enabled=False, checkable=True, shortcut="")
        self.applyBlurAct = QAction(QIcon('icons/blur.png'), "BlurPart", self, enabled=False, checkable=True, shortcut="")
